...
#chapter("Memory Safety", eyebrow: "Avoiding memory conflicts")
...
#image("/TSPL.docc/Assets/memory_shopping@2x.png")
...
_doesn't_ involve concurrent or multithreaded code.
...
use #link("https://developer.apple.com/documentation/xcode/diagnosing\_memory\_thread\_and\_crash\_issues\_early")[Thread Sanitizer]
...
#image("/TSPL.docc/Assets/memory_increment@2x.png")
...
#image("/TSPL.docc/Assets/memory_share_health_maria@2x.png")
...
#image("/TSPL.docc/Assets/memory_share_health_oscar@2x.png")
