...
#chapter("Attributes", eyebrow: "Declaration metadata")
...
These _attribute arguments_ are enclosed in parentheses,
...
see Expressions\#Macro-Expansion-Expression.
For information about property wrappers,
see Attributes\#propertyWrapper.
...
- `named(name)`
  where _name_ is that fixed symbol name,
...
- `prefixed(prefix)`
  where _prefix_ is prepended to the symbol name,
  for a name that starts with a fixed string.

- `suffixed(suffix)`
  where _suffix_ is appended to the symbol name,
...
Copying the implementation is also known as _emitting into the client_.
...
- The implementation satisfies the requirements for an inlinable function,
  described in Attributes\#inlinable.
...
#link("https://developer.apple.com/documentation/swift/expressiblebyarrayliteral")[`ExpressibleByArrayLiteral`]
...
must have a single parameter that conforms to the
#link("https://developer.apple.com/documentation/swift/expressiblebydictionaryliteral")[`ExpressibleByDictionaryLiteral`]
protocol,
and the return type can be any type.
The parameter's #link("https://developer.apple.com/documentation/swift/expressiblebydictionaryliteral/2294108-key")[`Key`]
must be
#link("https://developer.apple.com/documentation/swift/expressiblebystringliteral")[`ExpressibleByStringLiteral`].
The previous example uses #link("https://developer.apple.com/documentation/swift/keyvaluepairs")[`KeyValuePairs`]
...
#link("https://developer.apple.com/documentation/swift/keypath")[`KeyPath`],
#link("https://developer.apple.com/documentation/swift/writablekeypath")[`WritableKeyPath`],
or #link("https://developer.apple.com/documentation/swift/referencewritablekeypath")[`ReferenceWritableKeyPath`].
It can accept member names using an argument of a type that conforms to the
#link("https://developer.apple.com/documentation/swift/expressiblebystringliteral")[`ExpressibleByStringLiteral`] protocol ---
...
as discussed in Attributes\#inlinable.
...
as described in #link("https://help.apple.com/xcode/mac/current/\#/dev04b3a04ba")[Xcode Help].



A switch statement over a frozen enumeration doesn't require a `default` case,
as discussed in Statements\#Switching-Over-Future-Enumeration-Cases.
...
as discussed in Concurrency\#The-Main-Actor.
...
as discussed in Declarations\#Top-Level-Code.
...
use the Attributes\#main attribute instead.
In Swift 6,
...
This attribute causes the property's setter to be synthesized with a _copy_
...
as described in #link("https://developer.apple.com/library/content/documentation/Cocoa/Conceptual/ProgrammingWithObjectiveC/Conventions/Conventions.html\#//apple\_ref/doc/uid/TP40011210-CH10-SW1")[Conventions]
in #link("https://developer.apple.com/library/content/documentation/Cocoa/Conceptual/ProgrammingWithObjectiveC/Introduction/Introduction.html\#//apple\_ref/doc/uid/TP40011210")[Programming with Objective-C].
...
#link("https://developer.apple.com/documentation/swift/imported\_c\_and\_objective-c\_apis/importing\_swift\_into\_objective-c")[Importing Swift into Objective-C].
...
like #link("https://developer.apple.com/documentation/foundation/1395135-nsclassfromstring")[`NSClassFromString(_:)`],
...
+ Annotate imports with the `preconcurrency` attribute
   for modules that haven't enabled strict checking.
+ After migrating a module to strict checking,
...
The _wrapped value_ of the property
...
The _projected value_ for a wrapped property is a second value
...
see AdvancedOperators\#Result-Builders.
...
If you don't use this attribute,
supply a `main.swift` file with code at the top level
that calls the #link("https://developer.apple.com/documentation/uikit/1622933-uiapplicationmain")[`UIApplicationMain(_:_:_:_:)`] function.
For example,
...
The only supported protocol is #link("https://developer.apple.com/documentation/swift/sendable")[`Sendable`].
...
#link("https://developer.apple.com/documentation/swift/1538339-min/")[`min(_:_:)`]
function and a
#link("https://developer.apple.com/documentation/swift/sequence/1641174-min")[`min()`]
...
see Closures\#Autoclosures and Types\#Function-Type.
...
see Closures\#Escaping-Closures.
...
to the #link("https://developer.apple.com/documentation/swift/sendable")[`Sendable`] protocol.
...
see Statements\#Switching-Over-Future-Enumeration-Cases.
