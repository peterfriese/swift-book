...
#chapter("Enumerations", eyebrow: "Defining possible values")
...
Properties, Methods, Initialization,
...
#link("https://developer.apple.com/documentation/swift/caseiterable")[`CaseIterable`] protocol.
...
#image("/TSPL.docc/Assets/barcode_UPC@2x.png")
...
#image("/TSPL.docc/Assets/barcode_QR@2x.png")
...
see ControlFlow\#Patterns.

== Raw Values

The barcode example in Enumerations\#Associated-Values
...
`Character` values are described in StringsAndCharacters.
...
For more information, see Declarations\#Failable-Initializers.
]
