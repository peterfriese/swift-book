...
#chapter("Optional Chaining", eyebrow: "Safe optional access")
...
As demonstrated in OptionalChaining\#Optional-Chaining-as-an-Alternative-to-Forced-Unwrapping,
...
as described in Functions\#Functions-Without-Return-Values.
...
The example above in OptionalChaining\#Accessing-Properties-Through-Optional-Chaining
