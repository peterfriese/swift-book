...
#chapter("Automatic Reference Counting", eyebrow: "Managing object lifetimes")

Swift uses _Automatic Reference Counting_ (ARC)
...
#link("https://developer.apple.com/library/content/releasenotes/ObjectiveC/RN-TransitioningToARC/Introduction/Introduction.html")[Transitioning to ARC Release Notes]
...
that property, constant, or variable makes a _strong reference_ to the instance.
...
_never_ gets to a point where it has zero strong references.
...
This is known as a _strong reference cycle_.
...
AutomaticReferenceCounting\#Resolving-Strong-Reference-Cycles-Between-Class-Instances.
...
#image("/TSPL.docc/Assets/referenceCycle01@2x.png")
...
#image("/TSPL.docc/Assets/referenceCycle02@2x.png")
...
#image("/TSPL.docc/Assets/referenceCycle03@2x.png")
...
A _weak reference_ is a reference that doesn't keep a strong hold
...
#image("/TSPL.docc/Assets/weakReference01@2x.png")

The `Person` instance still has a strong reference to the `Apartment` instance,
but the `Apartment` instance now has a _weak_ reference to the `Person` instance.
...
#image("/TSPL.docc/Assets/weakReference03@2x.png")
...
an _unowned reference_ doesn't keep
...
the reference _always_ refers to an instance that hasn't been deallocated.
...
but a credit card will _always_ be associated with a customer.
...
Furthermore, a new `CreditCard` instance can _only_ be created
...
#image("/TSPL.docc/Assets/unownedReference01@2x.png")
...
#image("/TSPL.docc/Assets/unownedReference02@2x.png")
...
Swift also provides _unsafe_ unowned references for cases where
...
#image("/TSPL.docc/Assets/unownedOptionalReference@2x.png")
...
in which _both_ properties should always have a value,
...
as described in Initialization\#Two-Phase-Initialization.
...
as described in TheBasics\#Implicitly-Unwrapped-Optionals.
...
This strong reference cycle occurs because closures, like classes, are _reference types_.
When you assign a closure to a property,
you are assigning a _reference_ to that closure.
...
known as a _closure capture list_.
...
#image("/TSPL.docc/Assets/closureReferenceCycle01@2x.png")
...
by defining a _capture list_ as part of the closure's definition.
...
from AutomaticReferenceCounting\#Strong-Reference-Cycles-for-Closures above.
...
#image("/TSPL.docc/Assets/closureReferenceCycle02@2x.png")
