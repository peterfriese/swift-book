...
#chapter("Opaque and Boxed Protocol Types", eyebrow: "Hiding implementation details")
...
in the OpaqueTypes\#The-Problem-that-Opaque-Types-Solve section earlier in this chapter.
...
For example,
here's an _invalid_ version of the shape-flipping function
...
A boxed protocol type is also sometimes called an _existential type_,
which comes from the phrase
"there exists a type _T_ such that _T_ conforms to the protocol".
...
this indirection is called a _box_,
...
For more information, see TypeCasting\#Downcasting.
...
For example,
here's a version of the `Container` protocol from Generics:
