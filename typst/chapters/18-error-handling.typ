...
#chapter("Error Handling", eyebrow: "Responding to errors")

_Error handling_ is the process of responding to
...
see #link("https://developer.apple.com/documentation/swift/cocoa\_design\_patterns/handling\_cocoa\_errors\_in\_swift")[Handling Cocoa Errors in Swift].
]
...
must be handled by _some_ surrounding scope.
...
- In code that only propagates errors described by generic parameters,
  ...
  and using `rethrows`,
  see Declarations\#Rethrowing-Functions-and-Methods.
...
This syntax is also called _typed throws_
...
of _how_ execution leaves the current block of code ---
...
see ControlFlow\#Deferred-Actions.
