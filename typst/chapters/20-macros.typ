...
#chapter("Macros", eyebrow: "Compile-time code generation")
...
#figure(image("/TSPL.docc/Assets/macro-expansion@2x.png"), caption: "A diagram showing an overview of macro expansion.  On the left, a stylized representation of Swift code.  On the right, the same code with several lines added by the macro.")
...
- _Freestanding macros_ appear on their own,
...
A macro declaration defines the macro's _roles_ ---
...
see Attributes\#attached and Attributes\#freestanding
in Attributes.
...
#figure(image("/TSPL.docc/Assets/macro-expansion-full@2x.png"), caption: "Diagram showing the four steps of expanding macros.  The input is Swift source code.  This becomes a tree, representing the code's structure.  The macro implementation adds branches to the tree.  The result is Swift source with additional code.")
...
The Macros\#Implementing-a-Macro section below
...
known as an _abstract syntax tree_, or AST.
...
#figure(image("/TSPL.docc/Assets/macro-ast-original@2x.png"), caption: "A tree diagram, with a constant as the root element.  The constant has a name, magic number, and a value.  The constant's value is a macro call.  The macro call has a name, fourCharacterCode, and arguments.  The argument is a string literal, ABCD.")
...
#figure(image("/TSPL.docc/Assets/macro-ast-input@2x.png"), caption: "A tree diagram, with a macro call as the root element.  The macro call has a name, fourCharacterCode, and arguments.  The argument is a string literal, ABCD.")
...
#figure(image("/TSPL.docc/Assets/macro-ast-output@2x.png"), caption: "A tree diagram with the integer literal 1145258561 of type UInt32.")
...
#figure(image("/TSPL.docc/Assets/macro-ast-result@2x.png"), caption: "A tree diagram, with a constant as the root element.  The constant has a name, magic number, and a value.  The constant's value is the integer literal 1145258561 of type UInt32.")
