...
#chapter("Properties", eyebrow: "Stored and computed values")
...
as described in Initialization\#Default-Property-Values.
...
as described in Initialization\#Assigning-Constant-Properties-During-Initialization.
...
#image("/TSPL.docc/Assets/computedProperties@2x.png")
...
as described in Functions\#Functions-With-an-Implicit-Return.
...
Overriding properties is described in Inheritance\#Overriding.
...
see Initialization\#Initializer-Delegation-for-Value-Types
and Initialization\#Initializer-Delegation-for-Class-Types.
]
...
For information about `private`, see AccessControl.
]
...
in a similar manner to Properties\#Lazy-Stored-Properties.
...
#image("/TSPL.docc/Assets/staticPropertiesVUMeter@2x.png")
