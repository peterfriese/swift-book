...
#chapter("Subscripts", eyebrow: "Collection element access")

Classes, structures, and enumerations can define _subscripts_,
...
which defines a `TimesTable` structure to represent an _n_-times-table of integers:
...
#memo()[
An _n_-times-table is based on a fixed mathematical rule.
...
see CollectionTypes\#Accessing-and-Modifying-a-Dictionary.

#memo()[
Swift's `Dictionary` type implements its key-value subscripting
as a subscript that takes and returns an _optional_ type.
...
as discussed in Functions\#Variadic-Parameters
...
This definition of multiple subscripts is known as _subscript overloading_.
...
in CollectionTypes\#Creating-an-Array-with-a-Default-Value.
...
#image("/TSPL.docc/Assets/subscriptMatrix01@2x.png")
...
#image("/TSPL.docc/Assets/subscriptMatrix02@2x.png")
...
This kind of subscript is called a _type subscript_.
