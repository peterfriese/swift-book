...
#chapter("Extensions", eyebrow: "Adding functionality")
...
For more details, see Protocols\#Protocol-Extensions.
...
as described in Generics\#Extending-a-Generic-Type.
You can also extend a generic type to conditionally add functionality,
as described in Generics\#Extensions-with-a-Generic-Where-Clause.
...
as described in Initialization\#Initializer-Delegation-for-Value-Types.
