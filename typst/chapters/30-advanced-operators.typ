...
#chapter("Advanced Operators", eyebrow: "Custom and bitwise operators")

In addition to the operators described in BasicOperators,
...
#image("/TSPL.docc/Assets/bitwiseNOT@2x.png")
...
#image("/TSPL.docc/Assets/bitwiseAND@2x.png")
...
#image("/TSPL.docc/Assets/bitwiseOR@2x.png")
...
#image("/TSPL.docc/Assets/bitwiseXOR@2x.png")
...
#image("/TSPL.docc/Assets/bitshiftUnsigned@2x.png")
...
#image("/TSPL.docc/Assets/bitshiftSignedFour@2x.png")
...
#image("/TSPL.docc/Assets/bitshiftSignedMinusFour@2x.png")

This time, the sign bit is `1` (meaning “negative”),
and the seven value bits have a binary value of `124` (which is `128 - 4`):

#image("/TSPL.docc/Assets/bitshiftSignedMinusFourValue@2x.png")
...
#image("/TSPL.docc/Assets/bitshiftSignedAddition@2x.png")
...
#image("/TSPL.docc/Assets/bitshiftSigned@2x.png")
...
#image("/TSPL.docc/Assets/overflowAddition@2x.png")
...
#image("/TSPL.docc/Assets/overflowUnsignedSubtraction@2x.png")
...
as described in AdvancedOperators\#Bitwise-Left-and-Right-Shift-Operators.
...
#image("/TSPL.docc/Assets/overflowSignedSubtraction@2x.png")
...
#image("/TSPL.docc/Assets/vectorAddition@2x.png")
...
as described in Protocols\#Adopting-a-Protocol-Using-a-Synthesized-Implementation.
...
See AdvancedOperators\#Precedence-and-Associativity for an explanation of
...
see Declarations\#Operator-Declaration.
