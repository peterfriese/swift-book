...
#chapter("Methods", eyebrow: "Functions within types")
...
_Instance methods_ are functions that belong to instances of
...
as described in Functions\#Function-Argument-Labels-and-Parameter-Names.
...
Structures and enumerations are _value types_.
...
you can opt in to _mutating_ behavior for that method.
...
as described in Properties\#Stored-Properties-of-Constant-Structure-Instances:
...
These kinds of methods are called _type methods_.
