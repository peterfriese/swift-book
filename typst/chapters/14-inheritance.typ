...
#chapter("Inheritance", eyebrow: "Subclassing and overriding")

A class can _inherit_ methods, properties, and other characteristics
from another class.
When one class inherits from another,
the inheriting class is known as a _subclass_,
and the class it inherits from is known as its _superclass_.
...
to override _any_ inherited property,
...
For more information on property observers, see Properties\#Property-Observers.
